...
public class ProjectCachePutAspect {
    ...
    @Pointcut("@annotation(top.autuan.redis.anno.ProjectCachePut)")
    ...
    public Object afterReturning(JoinPoint joinPoint, Object result) {
        try {
            ...
            ProjectCachePut projectCachePut = method.getAnnotation(ProjectCachePut.class);
            if (null == projectCachePut) {
            ...
            String key = projectCachePut.key();
            ...
            if (isBaseType(result)) {
                ...
                bucket.set(tempVal.toString(), projectCachePut.expire(), projectCachePut.unit());
            } else {
                bucket.set(JSONUtil.toJsonStr(result), projectCachePut.expire(), projectCachePut.unit());
            }
            return result;
